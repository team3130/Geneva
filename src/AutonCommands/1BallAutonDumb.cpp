...
OneBallAutonDumb::OneBallAutonDumb()
{
	...
	Drive_DriveToDefense = new AutonDumbDrive();
...
void OneBallAutonDumb::Initialize()
{
	bool intakePosition;
...
void OneBallAutonDumb::Interrupted()
{
	End();
}
