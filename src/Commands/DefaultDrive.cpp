...
void DefaultDrive::Execute()
{
	...
	double moveThrottle = (-0.25 * OI::GetInstance()->stickL->GetRawAxis(3)) + 0.8;		//Get Slider Value
	double turnThrottle = (-0.25 * OI::GetInstance()->stickR->GetRawAxis(3)) + 0.8;		//Get Slider Value
